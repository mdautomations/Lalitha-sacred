...
<body>
    ...
    <div id="content">
        <div class="container-fluid">
            <h1>Visitation Path based Course Generation</h1>
            <div class="panel panel-default">
                <div class="panel-heading panel-heading-gray" id="coursegen" style="font-size: 26px; color: rgb(64, 176, 224);">
               Subjects and its Visitation Rate
                </div>
                <table id="datastables" class="table display" cellspacing="0" width="100%">
                    <thead>
                        <tr id="transcripts_list_header" >
                            <th>Subject</th>
                            <th>Visitation Rate</th>
                        </tr>
                    </thead>
                    <tbody id="dataIns">
            ...
            <div class="panel panel-default">
            <div class="panel-heading panel-heading-gray" id="coursegen" style="font-size: 26px; color: rgb(64, 176, 224);">
               Student Name and their path of Subject (Node) selection
             </div>
                 <table id="subjectpath" class="table display" cellspacing="0" width="100%">
                    <thead>
                        <tr id="transcripts_list_header" >
                            <th>Student</th>
                            <th>Subject Path</th>
             ...
             <div class="panel panel-default">
             <div class="panel-heading panel-heading-gray" id="coursegen" style="font-size: 26px; color: rgb(64, 176, 224);">
               Path Extracted based on the Most number of Visitation Rate
                </div>
                <table id="visitpath" class="table display" cellspacing="0" width="100%">
                    <thead>
                        <tr id="transcripts_list_header" >
                            <th>Path</th>
                            <th>Path Visitation Rate</th>
                        </tr>
                    </thead>
                    <tbody id="dataIns">
                 ...
                 <br><br>
                <div class="panel panel-default" id="colour">
                <div class="panel-heading panel-heading-gray" id="coursegen" style="font-size: 26px; color: rgb(64, 176, 224);">
               Final Course Generated for You!
                </div>
                <table id="finalpredict" class="table display" cellspacing="0" width="100%">
                    <thead>
                        <tr id="transcripts_list_header" >
                            <th>Subject </th>
                            <th>Priority</th>
...
<div id="tieup" style="
    ...
    font-size: 15px;
    display:none;
"> We could see a tie up on choosing the best courses for you. Please visit our testimonials to
                select your subjects much accurate ! 
                <a href="/user-public-users.jsp">Testimonial</a>
                </div>
        </div>
