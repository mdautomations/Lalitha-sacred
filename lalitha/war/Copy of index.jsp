    ...
    <div class="navbar navbar-main navbar-primary navbar-fixed-top" role="navigation">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.jsp">Social Course Creation and Maintainance Corner</a>
            </div>
...
<!--                             <li class="active"><a href="index.jsp">Timeline</a> -->
<!--                             </li> -->
        ...
        <div data-scrollable>
            ...
            <div class="sidebar-block">
                ...
                <ul class="list-about">
                    ...
                    <li><i class="fa fa-link"></i> <a href="#">PEC, Chennai</a>
                    </li>
                    ...
                    <ul>
                        ...
                        <i class="fa fa-fw fa-bell"></i>
                            ...
                            <div class="media-body">
                                <a href="" class="text-white">Requested  </a> <a href="" class="text-white">Software Engineering</a>
                        ...
                        <i class="fa fa-fw fa-bell"></i>
                            ...
                            <div class="media-body">
                               Undergoing  <a href="" class="text-white">Mathematics !</a>
                        ...
                        <i class="fa fa-fw fa-bell"></i>
                            ...
                            <div class="media-body">
                                Completed  <a href="" class="text-white">Data Mining</a> 
                        ...
                        <i class="fa fa-fw fa-bell"></i>
                            ...
                            <div class="media-body">
                             Completed   <a href="" class="text-white">Computer Graphics </a> 
        ...
        <nav class="navbar navbar-subnav navbar-static-top" role="navigation">
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="subnav">
                    <ul class="nav navbar-nav">
                        <li class="active"><a href="index.jsp"><i class="fa fa-fw icon-ship-wheel"></i> Timeline</a>
                        </li>
                        <li><a href="user-public-profile.jsp"><i class="fa fa-fw icon-user-1"></i> About</a>
                        </li>
                        <li><a href="user-public-users.jsp"><i class="fa fa-fw fa-users"></i> Courses</a>
                        </li>
                    </ul>
