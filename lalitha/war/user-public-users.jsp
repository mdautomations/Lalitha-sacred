...
<body>
    ...
    <div id="content">
        ...
        <div class="container-fluid">
            ...
            <div id="passion">
             <!-- <div class="timeline row" id="testimonial-append" data-toggle="gridalicious">
                 <div class="timeline-block">
                    <div class="panel panel-default user-box">
                        <div class="panel-body">
                            <div class="media">
                                <img src="images/people/50/guy-2.jpg" alt="people" class="media-object img-circle pull-left" />
                                <div class="media-body">
                                    <a href="" class="username" style="margin-left: 1%;">Adrian D.</a>
                                </div>
                                <div class="media-body">
                                   <i style="margin-left: 2%;">Software Develepor - 12/04/2015 </i>
                                </div>
                            </div>
                        </div>
                        <div class="panel-body bordered">
                            <p class="common-friends"><b>Feedback</b></p>
                            <i>This is a fantastic course, I enjoyed a lot studing here. PLease dont misst his golden oppurtunugyt.</i>
                        </div>
                        <div class="panel-body bordered">
                            <p class="common-friends"><b>Electives</b></p>
                           <i>	NetworkDesignandManagement, BioInformatics, LanguageTechnologies, UnixInternals, DataMiningandWarehousing, JavaScript</i>
                        </div>
                         <div class="panel-body bordered">
                            <p class="common-friends"><b>Email</b></p>
                           <a href="#"><i>sathya@mdautomations.com</i></a>
                        </div>
                        <div class="panel-footer">
                            <a href="mailto:sathya@mdautomations.com" class="btn btn-default btn-sm">Follow <i class="fa fa-share"></i></a>
                        </div>
                    </div>
                </div> 
            </div>  -->
